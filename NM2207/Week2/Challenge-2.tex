...
\textbf{Solution:} \emph{Because it is simple, lightweight, and widely
supported across various software applications, making it easy to share
and exchange structured data without complex formatting or specialized
software requirements.} \textbf{Question 1.2:} load the
...
\NormalTok{play\_listdata }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"playlist\_data.csv"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"Screenshot 2023{-}08{-}22 125518.jpg"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\textbf{Solution:} \emph{The skip argument is used to specify the number
of lines at the beginning of the CSV file that should be skipped while
reading the data. This is useful when your CSV file has header rows or
other metadata at the top that you want to ignore when loading the
actual data.}
...
\FunctionTok{print}\NormalTok{(play\_listdata)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#sales\_data \textless{}{-} read\_csv("sales\_data.csv")}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{head}\NormalTok{(play\_listdata)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{glimpse}\NormalTok{(play\_listdata)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{nrow}\NormalTok{(play\_listdata)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ncol}\NormalTok{(play\_listdata)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{dim}\NormalTok{(play\_listdata)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# From last question we can tell there are 26 DJs.}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{play\_listdata}\SpecialCharTok{$}\NormalTok{Location}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{play\_listdata}\SpecialCharTok{$}\NormalTok{Age}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ play\_listdata, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Age, }\AttributeTok{y =}\NormalTok{ Rating)) }
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ play\_listdata, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Age, }\AttributeTok{y =}\NormalTok{ Rating)) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Age"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Rating"}\NormalTok{,}
       \AttributeTok{title =} \StringTok{"Relationship between DJs\textquotesingle{} Ages and Ratings"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ play\_listdata, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Age, }\AttributeTok{y =}\NormalTok{ Rating)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Age"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Rating"}\NormalTok{,}
       \AttributeTok{title =} \StringTok{"Relationship between DJs\textquotesingle{} Ages and Ratings"}\NormalTok{) }\SpecialCharTok{+}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ play\_listdata, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Age, }\AttributeTok{y =}\NormalTok{ Rating)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{17}\NormalTok{, }\AttributeTok{size =} \DecValTok{4}\NormalTok{, }\AttributeTok{color =} \StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Age"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Rating"}\NormalTok{,}
       \AttributeTok{title =} \StringTok{"Relationship between DJs\textquotesingle{} Ages and Ratings"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{()}
\end{Highlighting}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ play\_listdata, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Age, }\AttributeTok{y =}\NormalTok{ Rating)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Age"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Rating"}\NormalTok{,}
       \AttributeTok{title =} \StringTok{"Relationship between DJs\textquotesingle{} Ages and Ratings"}\NormalTok{,}
       \AttributeTok{caption =} \StringTok{"There is no direct correlation between the age of rating of the DJs. There might be other factors influencing whether the audience like the DJ\textquotesingle{}s content."}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
